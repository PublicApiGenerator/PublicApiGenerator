...
// All this code was taken from https://github.com/dotnet/runtime/tree/main/src/libraries/System.CodeDom/src
// to fix https://github.com/PublicApiGenerator/PublicApiGenerator/issues/410
...
#pragma warning restore CA2249
    ...
    private void GenerateCommentStatement(CodeCommentStatement e)
    {
        if (e.Comment == null)
        {
            throw new ArgumentException(string.Format("The 'Comment' property of the CodeCommentStatement '{0}' cannot be null.", nameof(e)), nameof(e));
        }
    ...
    public void ValidateIdentifier(string value)
    {
        ...
        {
            throw new ArgumentException(string.Format("Identifier '{0}' is not valid.", value), nameof(value));
        }
    }
...
{
    public static int NestedArrayDepth(this CodeTypeReference r) => r.ArrayElementType == null ? 0 : 1 + r.ArrayElementType.NestedArrayDepth();
}
