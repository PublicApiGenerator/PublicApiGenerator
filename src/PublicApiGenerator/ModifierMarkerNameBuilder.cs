...
internal static class ModifierMarkerNameBuilder
{
    public static string Build(MethodDefinition methodDefinition, MemberAttributes getAccessorAttributes, bool? isNew, string name, string markerTemplate)
        => (getAccessorAttributes & MemberAttributes.ScopeMask, isNew, methodDefinition.IsVirtual, methodDefinition.IsAbstract) switch
        {
